...
#------------------------------------------------------------------------------
# Config for updateDevTemplates.sh, created on Do 14 Sep 2023 15:23:28 CEST
# Project-Type: ts
#------------------------------------------------------------------------------
...
# SCRIPT_TO_COPY["setup/install.default.packages.sh"]="install.default.packages.sh"

# Stellt die Filenamen auf .cjs um
SCRIPT_TO_COPY["setup/mv.to.module-type.sh"]="mv.to.module-type.sh"
